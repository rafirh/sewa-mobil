<?php
$active = 'laporan-merk-terlaris';
$title = 'Laporan Merk Terlaris';

include('partials/header.php');

$query = "
  SELECT
    merk_mobil.nama AS nama_merk,
  ...
  RIGHT JOIN merk_mobil ON merk_mobil.id = mobil.merk_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-merk-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
