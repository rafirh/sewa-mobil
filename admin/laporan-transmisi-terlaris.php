<?php
$active = 'laporan-transmisi-terlaris';
$title = 'Laporan Transmisi Terlaris';

include('partials/header.php');

$query = "
  SELECT
    transmisi.nama AS nama_transmisi,
  ...
  RIGHT JOIN transmisi ON transmisi.id = mobil.transmisi_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-transmisi-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
