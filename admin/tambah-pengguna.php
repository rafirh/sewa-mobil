...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (checkRequiredFields(['nama'])) {
    ...
    $query = "INSERT INTO user (nama, email, password, role, alamat, no_hp, foto) VALUES ('$nama', '$email', '$password', '$role', '$alamat', '$no_hp', '$foto')";
...
<div class="page-body">
  <div class="container-xl">
    <div class="row row-cards justify-content-center">
      <div class="col-md-10">
        <form action="tambah-pengguna.php" method="POST" enctype="multipart/form-data">
          <div class="card">
            <div class="card-body">
              <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                ...
                <div class="col">
                  <input required type="text" class="form-control" placeholder="Masukkan nama pengguna" name="nama">
                </div>
              </div>
              <div class="mb-3 row">
                <label class="col-md-4 col-12 col-form-label required">Email</label>
                <div class="col">
                  <input required type="email" class="form-control" placeholder="Masukkan email pengguna" name="email">
                </div>
              </div>
              <div class="mb-3 row">
                <label class="col-md-4 col-12 col-form-label required">Kata Sandi</label>
                <div class="col">
                  <div class="input-group input-group-flat">
                    <input required type="password" id="password" name="password" class="form-control" placeholder="Masukkan konfirmasi kata sandi">
              ...
              <div class="mb-3 row">
                ...
                <div class="col">
                  <input required type="text" class="form-control" placeholder="Masukkan alamat pengguna" name="alamat">
                </div>
              </div>
              <div class="mb-3 row">
                <label class="col-md-4 col-12 col-form-label required">No. HP</label>
                <div class="col">
                  <input required type="text" class="form-control" placeholder="Masukkan nomor hp pengguna" name="no_hp">
                </div>
              </div>
              <div class="mb-3 row">
