...
$query = "SELECT * FROM jenis_mobil WHERE nama != 'Lainnya'";
...
$jenis = $result->fetch_all(MYSQLI_ASSOC);
?>
    ...
    <div class="row g-2 align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none mt-3">
        <div class="btn-list d-flex">
          <a href="tambah-jenis-mobil.php" class="btn btn-primary d-none d-sm-inline-block" id="btnAdd">
          ...
          <a href="tambah-jenis-mobil.php" class="btn btn-primary d-sm-none btn-icon" data-bs-tooltip="Tambah Jenis Mobil" data-bs-placement="left">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
              <path d="M12 5l0 14"></path>
              <path d="M5 12l14 0"></path>
    ...
    <div class="row g-2 align-items-center">
      ...
      <?php if (isParamsExist(['q', 'sortby', 'order'])) : ?>
        <div class="col-auto mt-3">
          <a href="jenis-mobil.php" class="btn btn-outline-danger btn-icon" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
                    ...
                    <td>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="text-muted dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="ubah-jenis-mobil.php?id=<?= $item['id'] ?>">
                  ...
                  <tr class="text-center">
                    <td colspan="99">
                      <div class="empty bg-transparent" style="height: 500px;">
                        ...
                        <p class="empty-title">Jenis mobil tidak ditemukan</p>
                        <p class="empty-subtitle text-muted">
                          Coba sesuaikan pencarian atau filter untuk menemukan apa yang anda cari.
                        </p>
                        <div class="empty-action">
                          <a href="jenis-mobil.php" class="btn btn-outline-danger">
      ...
      <div class="modal-footer">
        <div class="w-100">
          <div class="row">
            ...
            <div class="col">
              <form method="post" id="formDelete" action="hapus-jenis-mobil.php">
