<?php
$active = 'laporan-warna-terlaris';
$title = 'Laporan Warna Terlaris';
...
$query = "
  ...
  RIGHT JOIN warna ON warna.id = mobil.warna_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-warna-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
              ...
              <tbody>
                <?php foreach ($laporan as $index => $item) : ?>
                  <tr class="text-muted">
                    ...
                    <td>
                      <span class="badge me-1" style="background-color: <?= $item['kode_warna'] ?>;"></span>
                      <?= $item['nama_warna'] ?>
                    </td>
                    <td>
