<?php
$active = 'laporan-metode-pembayaran-terbanyak';
$title = 'Laporan Metode Pembayaran Terbanyak';

include('partials/header.php');

$query = "
  SELECT
    metode_pembayaran.nama as nama_metode,
    COUNT(transaksi.id) AS total_transaksi,
    SUM(transaksi.total_harga) AS total_pendapatan
  FROM transaksi
  RIGHT JOIN metode_pembayaran ON metode_pembayaran.id = transaksi.metode_pembayaran_id
...
<div class="page-header d-print-none mt-2">
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        <h3 class="page-title">
          Laporan Metode Pembayaran Terbanyak
        </h3>
      </div>
    </div>
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date'])) : ?>
          <a href="laporan-metode-pembayaran-terbanyak.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
