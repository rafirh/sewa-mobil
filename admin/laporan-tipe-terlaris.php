<?php
$active = 'laporan-tipe-terlaris';
$title = 'Laporan Tipe Mobil Terlaris';

include('partials/header.php');

$query = "
  SELECT
    tipe_mobil.nama AS nama_tipe_mobil,
  ...
  RIGHT JOIN tipe_mobil ON tipe_mobil.id = mobil.tipe_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-tipe-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
