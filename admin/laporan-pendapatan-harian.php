<?php
$active = 'laporan-pendapatan-harian';
...
$query = "
  SELECT
    DATE(transaksi.tanggal_pemesanan) AS tanggal,
  ...
  <div class="container-xl">
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id'])) : ?>
          <a href="laporan-pendapatan-harian.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
