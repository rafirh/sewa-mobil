<?php
$active = 'laporan-agen-terlaris';
$title = 'Laporan Agen Terlaris';
...
$query = "
  ...
  FROM transaksi
  RIGHT JOIN agen ON agen.id = transaksi.agen_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date'])) : ?>
          <a href="laporan-agen-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
