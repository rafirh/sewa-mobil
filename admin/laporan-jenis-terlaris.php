<?php
$active = 'laporan-jenis-terlaris';
$title = 'Laporan Jenis Mobil Terlaris';

include('partials/header.php');

$query = "
  SELECT
    jenis_mobil.nama AS nama_jenis_mobil,
  ...
  RIGHT JOIN jenis_mobil ON jenis_mobil.id = mobil.jenis_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-jenis-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
