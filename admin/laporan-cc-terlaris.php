<?php
$active = 'laporan-cc-terlaris';
$title = 'Laporan CC Mobil Terlaris';
...
$query = "
  ...
  RIGHT JOIN cc ON cc.id = mobil.cc_id
    ...
    <div class="row g-2 align-items-center mt-2">
      <div class="col d-flex">
        ...
        <?php if (isParamsExist(['start_date', 'end_date', 'agen_id', 'merk_id'])) : ?>
          <a href="laporan-cc-terlaris.php" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-original-title="Clear filter" data-bs-placement="bottom">
