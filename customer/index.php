...
$belum_diambil = countAll(
  $conn,
  "transaksi",
  "(status_pembayaran_id = 4 OR status_pembayaran_id = 5) AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengembalian_id = 1"
);
$sedang_disewa = countAll(
  $conn,
  "transaksi",
  "(status_pembayaran_id = 4 OR status_pembayaran_id = 5) AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengembalian_id = 2"
);
$belum_lunas = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 4 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengembalian_id = 3 AND bukti_bayar_lunas IS NULL"
);
$pelunasan_belum_diverifikasi = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 4 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengembalian_id = 3 AND bukti_bayar_lunas IS NOT NULL"
);
$pesanan_selesai = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 5 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengembalian_id = 3"
);
?>
