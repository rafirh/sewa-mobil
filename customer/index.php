...
$jumlah_transaksi = countAll($conn, "transaksi", "user_id = {$_SESSION['user']['id']}");
$belum_dibayar = countAll($conn, "transaksi", "(status_pembayaran_id = 1 OR status_pembayaran_id = 3) AND user_id = {$_SESSION['user']['id']}");
$belum_diverifikasi = countAll($conn, "transaksi", "status_pembayaran_id = 2 AND user_id = {$_SESSION['user']['id']}");
$menunggu_pengiriman = countAll(
  $conn,
  "transaksi",
  "(status_pembayaran_id = 4 OR status_pembayaran_id = 5) AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 1"
);
$sedang_dikirim = countAll(
  $conn,
  "transaksi",
  "(status_pembayaran_id = 4 OR status_pembayaran_id = 5) AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 2"
);
$pesanan_terkirim = countAll(
  $conn,
  "transaksi",
  "(status_pembayaran_id = 4 OR status_pembayaran_id = 5) AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 3 AND transaksi.status_pengembalian_id = 1"
);
$belum_lunas = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 4 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 3 AND transaksi.status_pengembalian_id = 2 AND bukti_bayar_lunas IS NULL"
);
$pelunasan_belum_diverifikasi = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 4 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 3 AND transaksi.status_pengembalian_id = 2 AND bukti_bayar_lunas IS NOT NULL"
);
$pesanan_selesai = countAll(
  $conn,
  "transaksi",
  "status_pembayaran_id = 5 AND user_id = {$_SESSION['user']['id']} AND transaksi.status_pengiriman_id = 3 AND transaksi.status_pengembalian_id = 2"
);
?>
