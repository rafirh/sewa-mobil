      ...
      <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list d-flex">
            <a href="tambah-mobil.php" class="btn btn-primary d-none d-sm-inline-block"
              id="btnAdd">
            ...
            <a href="tambah-mobil.php" class="btn btn-primary d-sm-none btn-icon"
              data-bs-tooltip="Tambah Mobil" data-bs-placement="left">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="24"
                height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      ...
      <div class="row g-2 align-items-center">
        ...
        <div class="col-auto mt-3">
          <?php if (isParamsExist(['q', 'sortby', 'order', 'status', 'merk_id', 'jenis_id', 'transmisi_id', 'warna_id'])) : ?>
            <a href="mobil.php" class="btn btn-outline-danger btn-icon"
                    ...
                    <tr class="text-muted">
                      ...
                      <td>
                        <a class="avatar me-2 image-preview cursor-pointer"
                          ...
                          href="<?= asset($car['foto'] != '' ? $car['foto'] : 'images/default.png') ?>"
                          style="background-image: url(<?= asset($car['foto'] != '' ? $car['foto'] : 'images/default.png') ?>)">
                        </a>
                      </td>
                      <td>
                    ...
                    <tr class="text-center">
                      <td colspan="99">
                        <div class="empty bg-transparent" style="height: 500px;">
                          <div class="empty-img"><img src="<?= asset('images\error\undraw_quitting_time_dm8t.svg') ?>"
                              height="128">
                          </div>
              ...
              <div class="col-12">
                ...
                <div class="form-selectgroup">
                  <label class="form-selectgroup-item">
                    <input type="radio" name="status" value="available" class="form-selectgroup-input"
                      <?= ($_GET['status'] ?? '') == 'available' ? 'checked' : '' ?>>
                    <span class="form-selectgroup-label">
                      Tersedia
                    </span>
                  </label>
                  <label class="form-selectgroup-item">
                    <input type="radio" name="status" value="unavailable" class="form-selectgroup-input"
                      <?= ($_GET['status'] ?? '') == 'unavailable' ? 'checked' : '' ?>>
                    <span class="form-selectgroup-label">
                      Tidak Tersedia
                    </span>
                  </label>
